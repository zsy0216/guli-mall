...
class MallThirdPartyApplicationTests {
    ...
    public void sendSmsCode() {
        smsComponent.sendCode("18862216356", "134531");
    }
    ...
    public void testUpload() throws FileNotFoundException {
        ...
        String accessKeyId = "LTAI5tJgQd5U7eiq6hcJTH9b";
        String accessKeySecret = "zrVtfOwYVGhr9TDtrqqsmCSloBkROt";
        // 创建OSSClient实例。
        OSS ossClient = new OSSClientBuilder().build(endpoint, accessKeyId, accessKeySecret);
        // 上传文件流。
        InputStream inputStream = new FileInputStream("/Users/csk/Desktop/WX20220929-111512.png");
        ossClient.putObject("chengsukai", "1.png", inputStream);
        // 关闭OSSClient。
        ossClient.shutdown();
